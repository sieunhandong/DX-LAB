...
public class DeleteControll extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (acc == null || acc.getRole_id() == 1 || acc.getRole_id() == 2 || acc.getRole_id() == 5 || acc.getRole_id() == 6) {
            ...
            if (service.equals("deleteInterviewSchedule")) {
                int notificationId = Integer.parseInt(request.getParameter("interviewschedule_id"));
                HRDAO ndao = new HRDAO();
                ndao.deleteInterviewScheduleById(notificationId);
