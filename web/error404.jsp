<%-- 
    Document   : error404
    Created on : Mar 7, 2024, 2:35:40 AM
    Author     : ADMIN
--%>
        ...
        <div class="container">
            <div class="left-section">
                <div class="inner-content">
                    <h1 class="heading" style="font-weight: 100px">Come back!</h1>
                    <p class="subheading">You do not have permission to access this page.</p>
